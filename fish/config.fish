cat /home/andre/.cache/wal/sequences
#  ____ _____
...
alias test='echo "$PATH[1]"'

# root privileges
alias doas="doas --"
alias build="sudo make clean install"
alias xreload="xrdb -merge -I$HOME ~/.Xresources"
# navigation
alias ..='cd ..'
alias ...='cd ../..'
alias .3='cd ../../..'
alias .4='cd ../../../..'
alias .5='cd ../../../../..'
alias passcache='git config --global credential.helper cache'
# vim and emacs
alias vim='nvim'
